...
def hand_baseline(net_type, output_dir):
    ...
    # data layers
    if net_type == 'train':
        pose_data_param_train = dict(image_source='{}/cache/train_image.txt'.format(output_dir),
                                 label_source='{}/cache/train_label.txt'.format(output_dir),
        ...
        pose_data_param_test = dict(image_source='{}/cache/test_image.txt'.format(output_dir),
                                 label_source='{}/cache/test_label.txt'.format(output_dir),
                                 root_folder=root_folder_,
...
def make_baseline_net(output_dir):
    # with open('model_nyu/handpose_baseline_nyu.prototxt'.format(iter), 'w') as f:
    ...
    # with open('model_nyu/solver_handpose_baseline_nyu.prototxt'.format(iter), 'w') as f:
