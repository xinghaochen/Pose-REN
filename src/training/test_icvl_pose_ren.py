...
weights_init = '../../models/icvl_baseline.caffemodel'.format(snapshot_dir) # init model: baseline model
weights_pose_ren = '{}/icvl_pose_ren_s{}_iter_160000.caffemodel'.format(snapshot_dir, idx)
...
for iter_idx in xrange(iter_num+1):
    ...
    if not os.path.exists(weights):
        ...
        exit()
    init_label_test = '{}/predicted_icvl_pose_ren_s{}.txt'.format(result_dir, iter_idx)
    log_suffix = '{}/log_final_test_icvl'.format(log_dir)
